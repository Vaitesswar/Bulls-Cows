...
public class ModelDB {
	...
	public ModelDB(int gameID, int no1, int no2, int no3, int no4, Timestamp timeStamp, int partial, int exact,
			boolean status) {
		super();
		this.gameID = gameID;
		this.no1 = no1;
	...
	public String toString() {
		return "ModelDB [gameID=" + gameID + ", no1=" + no1 + ", no2=" + no2 + ", no3=" + no3 + ", no4=" + no4
